<%-- 
    Document   : ar-app
    Created on : 22-Apr-2020, 00:05:38
    Author     : PC
--%>
...
<html>
    ...
    <head>
        ...
        <title>Roundabout Sim - AR Application</title>
    ...
    <body>
        ...
        <div class="main-wrap">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">AR Application</li>
            </ol>
            <div class="center-item">
                <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">Augmented Reality Application</h1>
            ...
            <div class="center-item" data-aos="fade-up" data-aos-offset="10" data-aos-delay="5" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">
                <img src="img/targetImage.jpg"/>

                <p class="text-gap">
                    <br>
                    1.		This application is for android phones only.<br><br>
                    2.		Download the application on your phone by clicking the download button below.<br><br>
                    3.		Launch the application on you phone, this will open up your camera.<br><br>
                    4.		View the image above through your phone to play the video.<br>
