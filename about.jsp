<%-- 
    Document   : about
    Created on : 21-Apr-2020, 22:53:54
    Author     : PC
--%>
...
<head>
    ...
    <title>Roundabout Sim - About</title>
...
<body>
    ...
    <nav>
        ...
        <ul class="menu">
            ...
            <li><a class="active" href="UserController?menu=About">About</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="center-item">
            <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">About Us</h1>
        ...
        <div class="text-section" data-aos="fade-up" data-aos-offset="10" data-aos-delay="5" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">
            ...
            <hr>
            <h4>Subtitle</h4>
            <p>Proin eget tortor risus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorpsum id orci porta dapibus. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorpsum id orci porta dapibus. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Nulla quis lorem ut libero malesuada feugiat. Donec velit neque, auctor sit amet aliquam vel, ullamcorpsum id orci porta dapibus. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Nulla quis lorem ut libero malesuada feugiat.</p>
        </div>
