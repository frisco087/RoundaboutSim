<%-- 
    Document   : promo-video
    Created on : 22-Apr-2020, 00:06:22
    Author     : PC
--%>
    ...
    <body>
        ...
        <nav>
            ...
            <ul class="menu">
                ...
                <li data-brackets-id='3525'><a data-brackets-id='3526' href="logSignIn.jsp">Sign In/Up</a></li>
            </ul>
            <div class="burger">
                <div class="line1"></div>
                <div class="line2"></div>
        ...
        <div class="main-wrap">
            ...
            <div class="center-item" data-aos="fade-up" data-aos-offset="10" data-aos-delay="5" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">
               <iframe width="80%" height="600px" src="https://www.youtube.com/embed/QSVyyykaEOo?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <p class="text-gap">Proin eget tortor risus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula.
                </p> 
