        ...
        <div class="main-wrap">
            ...
            <div class="login-box">
                <div class="center-item">
                    <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">Admin Area</h1>
                        ...
                        <div class="rowpad">
                            <c:forEach var="users" items="${allusers}">       
                                <div class="panel">
                                    ...
                                    <h3>ID : ${users.userid}</h3>
                                    <p>Username : ${users.username}</p>
                                    <p>Password : ${users.password}</p>
                                    <p>Email : ${users.email}</p>

                                    <div class="flex-containershowpanel">
                                        <a  href="UserController?menu=getUserView&user_id=${users.userid}"><button class="btn-admin btn hvr-sweep-to-right">Update User</button></a> 
                                        <a  href="UserController?menu=DeleteUser&user_id=${users.userid}"><button class="btn-admin btn hvr-sweep-to-right">Delete User</button></a>
                                    </div>
