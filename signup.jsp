...
<html lang="en">
    ...
    <head>
        ...
        <title>Roundabout Sim - Sign Up</title>
...
<!--            <ul class="menu">
                ...
                <li><a class="active" href="login.jsp">Sign In/Up</a></li>
            </ul>-->
<!--            <div class="burger">
                <div class="line1"></div>
                <div class="line2"></div>
...
<!--            <ol class="breadcrumb">
            ...
            <div class="login-box">
                <div class="center-item">
                    <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">Sign Up</h1>
                ...
                <div class="row" data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">
                    <div class="">
                        <div class="rowpad">
                            <form action="UserController" method="post" class="login-form" name="SignUp">
                                ...
                                <div class="control-group form-group">
                                    <div class="controls input-container">
                                        ...
                                        <input type="password" name="password2" placeholder="Confirm Password" id="confirm_password" class="form-control" required data-validation-required-message="Please enter your password.">
                                        <p><input type="checkbox" onclick="myFunction2()">Show Password</p>
                                    </div>
                                </div>

                                <div id="success"></div>
                                <!-- For success/fail messages -->
                                <button type="submit" name="menu" value="Process SignUp" class="btn btn-primary hvr-sweep-to-right" id="sendMessageButton">Sign Up</button><br><br>
                                <p class="center-item">or</p>
                                <a href="UserController?menu=Login"><button type="button" name="menu" value="SignUp" class="btn btn-primary hvr-sweep-to-right" id="">Login</button></a>
                            </form>
                        </div>
                    </div>
