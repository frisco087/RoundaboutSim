<%-- 
    Document   : cookies
    Created on : 11-May-2020, 16:14:03
    Author     : PC
--%>
...
<head>
    ...
    <title>Roundabout Sim - Cookies</title>
...
<body>
    ...
    <div class="main-wrap">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Cookie Policy</li>
        </ol>


        <div class="contact-box">
            <div class="center-item">
                <h1 data-aos="fade-up" data-aos-offset="10" data-aos-delay="200" data-aos-duration="400" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top">Cookie Policy</h1>
